    ...
    public void loadDataTable(){
        ...
        for(TaiKhoanDTO tk : dsnv){
            tblModel.addRow(new Object[]{
                    tk.getTenDangNhap(), tk.getMatKhau(), tk.getTrangThai(), tk.getChucVu(), tk.getId_nhanVien()
            });
        }
    }
    public void timKiemNhanVien(){
        ...
        if(key.isEmpty()){
            ...
            for(TaiKhoanDTO nv : dsnv) {
                tblModel.addRow(new Object[]{
                        nv.getTenDangNhap(), nv.getMatKhau(), nv.getTrangThai(), nv.getChucVu(), nv.getId_nhanVien()});
            }
        }
    }
}
